...
public class Location {
  ...
  /**
   * Construct a new model.Location with a named provider.
   *
  ...
  /** Construct a new model.Location object that is copied from an existing one. */
   ...
   * to calculate the age of a fix and to compare model.Location fixes. This is reliable because
   * elapsed real-time is guaranteed monotonic for each system boot and continues to increment even
   * when the system is in deep sleep (unlike {@link #getTime}.
   *
   * <p>All locations generated by the {@link LocationManager} are guaranteed to have a valid
   * elapsed real-time.
   *
   ...
   * the accuracy of bearing, velocity or altitude if those are included in this model.Location.
   *
